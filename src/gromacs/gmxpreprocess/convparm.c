       ...
       case F_TWOGAUSS:
  	    ...
  	    newparam->twogauss.mu2    = old[3];
   	    ...
   	    newparam->twogauss.rad    = old[5];
    	    break;
       case F_TANH_BOX:
    	    newparam->tanhbox.xl = old[0];
  	    newparam->tanhbox.xr = old[1];
  	    newparam->tanhbox.sg = old[2];
  	    newparam->tanhbox.lm = old[3];
 	    break;
       ...
       case F_TWOANGLE:
        ...
        case F_TWODIHS:
  	    newparam->twodihs.amp=old[0];
   	    newparam->twodihs.mu1=min(old[1],old[2]);
   	    newparam->twodihs.mu2=max(old[1],old[2]);
   	    break;
        case F_CONSTR:
        case F_CONSTRNC:
