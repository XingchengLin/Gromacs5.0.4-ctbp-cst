    ...
    switch (ftype)
    {
       ...
       case F_TWOGAUSS:
  	    ...
  	    gmx_fio_do_real(fio,iparams->twogauss.rad);
   	    break;
       case F_TANH_BOX:
   	    gmx_fio_do_real(fio,iparams->tanhbox.xl);
  	    gmx_fio_do_real(fio,iparams->tanhbox.xr);
  	    gmx_fio_do_real(fio,iparams->tanhbox.sg);
  	    gmx_fio_do_real(fio,iparams->tanhbox.lm);
  	    break;
